...
현재 웹 시안의 대화 내용이나 입양 준비 메모는 새로고침하면 초기화돼. 서버에는 대화방·메시지와 [입양 준비 메모 저장 API](docs/adoption-notes-api.md)가 준비됐지만 시안과 아직 연결하지 않았어. 체크하거나 메모를 적어도 실제 입양 신청이나 서류 제출이 되는 건 아니야.
